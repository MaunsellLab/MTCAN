function [taskNames, taskEvents, taskSpikes, nevFile] = extractNEVData(NEV)
...
addpath('/Users/chery/Documents/Grad School/Maunsell Lab/Analysis/MTCAN/NEV/');
    % for testing
    if nargin < 1
        directory =['/Users/chery/Documents/Grad School/Maunsell Lab/Analysis/MTCAN/NEV/'];      	% .nev file (don't include .nev extension)
        nevFile = 'Meetz_2022_0211_MTCNev001';  % directory for .nev file
...
sessionId = input('Enter MouseID and File Info: ', 's');
filestr = strcat(sessionId,'_','NEV','.mat');
clearvars -except taskNames taskSpikes taskEvents nevFile directory filestr 
save([directory filestr]);
