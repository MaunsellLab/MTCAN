...
incorporated frame counter, gaussian filter and fixed bug relating to unit indexing
...
for file in fileList:
    ...
    seshUnitIDs = []
    for unit in units:
        seshUnitIDs.append(f'{seshDate}_{unit}')
    seshUnitIDs = np.array(seshUnitIDs)
    ...
    np.save('sessionUnitIDs', seshUnitIDs)
